# Literature Review Repository for Explainable AI (XAI) applied to Time Series
...
* [Time Series Classication (TSC) Systematic Review and Surveys](https://github.com/bzamith/XAI_TimeSeries_LiteratureReview/blob/main/categorized/TSCSystematicReview.md)
